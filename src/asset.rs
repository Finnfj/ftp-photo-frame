...
pub fn welcome_screen(screen_size: (u32, u32), rotation: Rotation) -> Result<DynamicImage> {
...
pub fn error_screen(screen_size: (u32, u32), rotation: Rotation) -> Result<DynamicImage> {
    #[cfg(not(target_os = "windows"))]
...
pub fn update_icon((screen_width, _): (u32, u32), rotation: Rotation) -> Result<DynamicImage> {
    #[cfg(not(target_os = "windows"))]
